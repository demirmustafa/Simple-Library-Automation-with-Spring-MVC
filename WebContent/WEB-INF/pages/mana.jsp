					...
					<table class="table table-striped" id="allUsers">
						...
						<tbody>
							...
							<c:forEach var="author" items="${authors}">
								<tr>
									<form
										action="${pageContext.request.contextPath }/admin/deleteauthor/"
										method="post">
										<td><input type="text" class="form-control" name="id"
											readonly="readonly" value="${author.id }" style="width: 50px;"></td>

										<td><input type="text" class="form-control" name="name"
											value="${author.name }" style="width: 130px;"></td>
											
											<td><input type="text" class="form-control" name="name"
											value="${author.surname }" style="width: 130px;"></td>
						...
						<div class="row">
							<div class="col-md-4 col-md-offset-3">
								<form class="forn-signin"
									action="${pageContext.request.contextPath}/addnewauthor/"
									method="post">
									<h2 class="forn-signin-heading">Add New Author</h2>
									<label for="inputEmail" class="sr-only">Author Name</label> <input
										style="width: 170px;" type="text" id="inputEmail"
										class="form-control" name="name" placeholder="Author Name"
										required autofocus> <p/> <p/>
										
										<label for="inputEmail" class="sr-only">Author Surname</label> <input
										style="width: 170px;" type="text" id="inputEmail"
										class="form-control" name="surname" placeholder="Author Surname"
